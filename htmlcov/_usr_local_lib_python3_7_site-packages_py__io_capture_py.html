...
<head>
    ...
    <title>Coverage for /usr/local/lib/python3.7/site-packages/py/_io/capture.py: 19%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/local/lib/python3.7/site-packages/py/_io/capture.py</b> :
